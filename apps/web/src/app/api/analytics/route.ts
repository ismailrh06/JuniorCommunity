...
export async function GET() {
  ...
  if (isMock) {
    ...
    return NextResponse.json({
      summary: [
        { event: "signup",           total: 142, unique_users: 142, last_7d: 12, last_30d: 38 },
        { event: "path_started",     total: 118, unique_users: 99,  last_7d: 9,  last_30d: 31 },
        { event: "module_started",   total: 687, unique_users: 94,  last_7d: 54, last_30d: 187 },
        { event: "module_completed", total: 423, unique_users: 87,  last_7d: 38, last_30d: 129 },
        { event: "project_applied",  total: 56,  unique_users: 44,  last_7d: 7,  last_30d: 22 },
        { event: "badge_earned",     total: 94,  unique_users: 71,  last_7d: 11, last_30d: 28 },
      ],
      mode: "mock",
    });
  }
  ...
  const aggregated: Record<string, { total: number; unique_users: Set<string>; last_7d: number; last_30d: number }> = {};
  const now = Date.now();
  ...
  for (const row of (data ?? []) as any[]) {
    if (!aggregated[row.event]) {
      aggregated[row.event] = { total: 0, unique_users: new Set(), last_7d: 0, last_30d: 0 };
    }
