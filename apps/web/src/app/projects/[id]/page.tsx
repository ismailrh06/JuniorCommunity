...
const MOCK_PROJECTS: Project[] = [
  {
    ...
    requirements: {
      fr: ["Maîtriser HTML/CSS/JS", "Connaître Next.js et Tailwind", "Lire un design Figma"],
      en: ["Master HTML/CSS/JS", "Know Next.js and Tailwind", "Read a Figma design"],
      es: ["Dominar HTML/CSS/JS", "Conocer Next.js y Tailwind", "Leer un diseño Figma"],
    },
    deliverables: {
      fr: ["Code source sur GitHub", "Site déployé sur Vercel", "Rapport de livraison"],
      en: ["Source code on GitHub", "Site deployed on Vercel", "Delivery report"],
      es: ["Código fuente en GitHub", "Sitio desplegado en Vercel", "Informe de entrega"],
    },
    postedAt: "2026-06-01",
  },
  {
    ...
    requirements: {
      fr: ["Maîtriser Figma", "Notions d'UX Design", "Portfolio avec au moins 1 projet UI"],
      en: ["Master Figma", "Basic UX Design knowledge", "Portfolio with at least 1 UI project"],
      es: ["Dominar Figma", "Conocimientos básicos de UX Design", "Portfolio con al menos 1 proyecto UI"],
    },
    deliverables: {
      fr: ["Fichier Figma complet", "Prototype interactif", "Design system documenté"],
      en: ["Complete Figma file", "Interactive prototype", "Documented design system"],
      es: ["Archivo Figma completo", "Prototipo interactivo", "Sistema de diseño documentado"],
    },
    postedAt: "2026-06-03",
  },
  {
    ...
    requirements: {
      fr: ["Python & Pandas", "Visualisation de données", "Streamlit ou Plotly"],
      en: ["Python & Pandas", "Data visualization", "Streamlit or Plotly"],
      es: ["Python & Pandas", "Visualización de datos", "Streamlit o Plotly"],
    },
    deliverables: {
      fr: ["Code source GitHub", "Dashboard déployé en ligne", "Guide d'utilisation"],
      en: ["GitHub source code", "Live deployed dashboard", "User guide"],
      es: ["Código fuente GitHub", "Dashboard desplegado en línea", "Guía de uso"],
    },
    postedAt: "2026-06-05",
  },
];
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          {project ? (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h1 className="text-xl font-bold text-gray-900 leading-tight">{project.title[language]}</h1>
                    <p className="text-sm text-gray-500 mt-1">
                      {copy.client}: <span className="font-medium text-gray-700">{project.client}</span>
                    </p>
                    <div className="flex items-center gap-2 mt-1 text-xs text-gray-400">
                      <Calendar className="h-3.5 w-3.5" />
                      {copy.posted} · {new Date(project.postedAt).toLocaleDateString(language === "fr" ? "fr-FR" : "en-GB")}
                    </div>
                  </div>
                </div>
                ...
                {project.requiredBadge && (
                  <div className="mt-4 flex items-center gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                    ...
                    <span className="text-sm text-amber-800">
                      <span className="font-semibold">{copy.requiredBadge}:</span>{" "}
              ...
              {/* ── Description ── */}
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <h2 className="text-base font-bold text-gray-900 mb-3">{copy.description}</h2>
                <p className="text-sm text-gray-600 leading-relaxed">{project.description[language]}</p>
              </div>

              {/* ── Tags ── */}
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <h2 className="text-base font-bold text-gray-900 mb-3">{copy.tags}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                  <h2 className="text-base font-bold text-gray-900 mb-3">{copy.requirements}</h2>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                  <h2 className="text-base font-bold text-gray-900 mb-3">{copy.deliverables}</h2>
                  <ul className="space-y-2">
              ...
              <div className="bg-brand-50 border border-brand-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <p className="font-bold text-brand-900">{project.title[language]}</p>
                  <p className="text-sm text-brand-700">{project.budget} · {project.duration[language]}</p>
                </div>
            ...
            <div className="text-center py-24">
              ...
              <Link href="/marketplace" className="inline-block mt-6 text-brand-600 hover:underline text-sm font-medium">
                {copy.back}
              </Link>
            </div>
          )}
