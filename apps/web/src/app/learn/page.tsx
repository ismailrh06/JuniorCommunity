...
> = {
  fr: {
    ...
    subtitle:
      "Choisis ton parcours. Chaque module = un projet concret. Obtiens ton badge Ready Junior et accède à la marketplace.",
    sectionTitle: "Choisir ton parcours",
    modules: "modules",
    start: "Commencer",
    badgesTitle: "Système de badges",
    badgesSubtitle:
      "Chaque compétence validée = un badge sur ton profil public.",
    benefits: [
      {
        title: "Guidé pas à pas",
        desc: "Des modules progressifs avec objectifs clairs et feedback rapide.",
      },
      {
        title: "100% pratique",
        desc: "Chaque étape te pousse à livrer un résultat concret, pas juste regarder une vidéo.",
      },
      {
        title: "Accès marché",
        desc: "Atteins Verified Junior et débloque la marketplace de missions réelles.",
      },
    ],
  },
  en: {
    ...
    subtitle:
      "Choose your path. Every module = one concrete project. Earn your Ready Junior badge and unlock the marketplace.",
    ...
    benefits: [
      {
        ...
        desc: "Progressive modules with clear goals and fast feedback.",
      },
      {
        title: "100% practical",
        desc: "Every step pushes you to ship real outcomes, not just watch videos.",
      },
      {
        title: "Marketplace access",
        desc: "Reach Verified Junior and unlock real mission opportunities.",
      },
    ],
  },
  es: {
    ...
    subtitle:
      "Elige tu ruta. Cada módulo = un proyecto concreto. Consigue tu badge Ready Junior y desbloquea el marketplace.",
    ...
    benefits: [
      {
        ...
        desc: "Módulos progresivos con objetivos claros y feedback rápido.",
      },
      {
        title: "100% práctico",
        desc: "Cada etapa te impulsa a entregar algo real, no solo ver videos.",
      },
      {
        title: "Acceso al mercado",
        desc: "Alcanza Verified Junior y desbloquea misiones reales.",
      },
    ],
  },
};
...
const BADGES: Array<{
...
}> = [
  {
    ...
    desc: {
      ...
      en: "Structure & semantics",
      es: "Estructura y semántica",
    },
  },
  {
    icon: "🔵",
    name: "Git Ready",
    desc: {
      fr: "Versionning & GitHub",
      en: "Versioning & GitHub",
      es: "Versionado y GitHub",
    },
  },
  {
    icon: "🟣",
  ...
  },
  {
    ...
    desc: {
      fr: "Premier projet live",
      en: "First live project",
      es: "Primer proyecto en vivo",
    },
  },
  {
    icon: "🟡",
    name: "Verified Junior",
    desc: {
      fr: "Prêt pour la marketplace",
      en: "Ready for marketplace",
      es: "Listo para el marketplace",
    },
  },
];
          ...
          {LEARNING_PATHS.map((path) => (
            ...
            >
              ...
              <div className="flex items-center justify-between text-xs text-white/50">
                <span>
                  {path.modulesCount} {copy.modules}
                </span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {BADGES.map((badge) => (
              <div
                key={badge.name}
                className="rounded-2xl border border-white/15 bg-white/[0.04] p-4 text-center transition-all hover:border-white/30 hover:bg-white/[0.08]"
              >
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {copy.benefits.map(({ title, desc }, idx) => {
            ...
            return (
              <div
                key={title}
                className="rounded-2xl border border-white/15 bg-white/[0.04] p-6 transition hover:bg-white/[0.08]"
              >
